  ...
  <div class="app-container">
    ...
    <el-row>
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="message" label="公告"></el-table-column>
        ...
        <el-table-column label="操作" width="200">
          <template slot-scope="scope">
            <el-button type="primary" size="small" icon="el-icon-edit" @click="toEditMessage(scope.row)">编辑</el-button>
      ...
      <el-dialog title="新增管理员" :visible.sync="addVisible">
        <div style="width: 80%;margin: 0 auto;">
          <el-row>
            ...
            <el-col :span="18"><el-input type="textarea" v-model="message.message" placeholder="请输入..." /></el-col>
          </el-row>
        </div>
        <div slot="footer" class="dialog-footer">
          <el-button @click="addVisible = false">取 消</el-button>
          <el-button v-if="!isEdit" type="primary" @click="saveNewMessage">保存</el-button>
...
<script>
import { save, deleteById, getPage } from '@/api/message'
export default {
  name: 'MessageIndex',
  data() {
    return {
  ...
  methods: {
    ...
    toEditMessage(row) {
      this.isEdit = true
      this.addVisible = true
      this.message.message = row.message
